...
class DatabaseSeeder extends Seeder
{
	...
	private $arrayPeliculas = array(
		...
		array(
			...
			'poster' => 'http://es.web.img3.acsta.net/c_215_290/pictures/14/02/27/09/35/442750.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://vignette.wikia.nocookie.net/doblaje/images/7/75/ElGolpe.jpg/revision/latest?cb=20120116135504&path-prefix=es', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://images-na.ssl-images-amazon.com/images/I/61z76H0cedL._SY445_.jpg', 
			'rented' => false, 
		...
		array(
			...
			'poster' => 'https://upload.wikimedia.org/wikipedia/el/thumb/7/7d/Se7en.jpg/250px-Se7en.jpg', 
			'rented' => true, 
		...
		array(
			...
			'year' => '1987', 
			'director' => 'Stanley Kubrick', 
			'poster' => 'https://images-na.ssl-images-amazon.com/images/I/51%2BHrjZnyfL.jpg', 
			'rented' => true, 
		...
		array(
			...
			'poster' => 'https://infomaniakos.com/wp-content/uploads/2018/02/Portada-Blade-Runner-2049-3D.jpg', 
			'rented' => true, 
		...
		array(
			...
			'year' => '1976', 
			'director' => 'Martin Scorsese', 
			'poster' => 'https://hopeliesat24framespersecond.files.wordpress.com/2011/04/170448-1020-a.jpg', 
			'rented' => false, 
		...
		array(
			...
			'year' => '1999', 
			'director' => 'David Fincher', 
			'poster' => 'https://cdn.shopify.com/s/files/1/1057/4964/products/fight-club-vintage-movie-poster-original-1-sheet-27x41-7183.jpg?v=1535846737', 
			'rented' => true, 
    ...
    public function run()
    {
        ...
        /*
		El método call lo que hace es
		llamar al método run de la clase
		indicada
        */
    }

    public function seedCatalogo(){
    ...
    public function seedUsers(){
    	...
    	$user4=new User;
    	$user4->name='invitado';
    	$user4->email='invitado@gmail.com';
    	$user4->password= bcrypt('invitado');
    	$user4->save();
    	$user5=new User;
    	$user5->name='esteban';
    	$user5->email='esteban@gmail.com';
    	$user5->password= bcrypt('esteban');
    	$user5->save();
    }
}
